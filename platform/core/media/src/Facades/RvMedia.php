 ...
 * @method static array getOptimizableMimeTypes()
 * @method static string imageValidationRule()
 * @method static array optimizeExistingImage(\Botble\Media\Models\MediaFile $file, int|null $maxWidth = 2560, int|null $maxHeight = 2560, int $quality = 82)
